...
for (i in 9:12) {
  ...
  load("UK/forecasts/ar.rda")
  y_bench = forecasts[, i]
  
  load("UK/forecasts/yout.rda")
  y_real = yout[, 1]
  
  load("UK/forecasts/l2boost.rda")
  x = forecasts[, i]
...
# 
# plot(csfe_list[[1]], type = "l", col = "red", xlab = "Janela móvel", ylab = "CSFE", lty = 1, ylim = c(-0.5, 1.1), cex.lab = 0.8, cex.axis = 0.8)
...
# par(mar = c(8, 4, 1, 1) + 0.1)
# 
# plot(csfe_list[[5]], type = "l", col = "red", xlab = "Janela móvel", ylab = "CSFE", lty = 1, ylim = c(-3.7, 0.9), cex.lab = 0.8, cex.axis = 0.8)
...
plot(csfe_list[[9]], type = "l", col = "red", xlab = "Janela móvel", ylab = "CSFE", lty = 1, ylim = c(-1.3, 0.2), cex.lab = 0.8, cex.axis = 0.8)
